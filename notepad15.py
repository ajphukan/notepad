...
def about_cmd():
    label = tkMessageBox.showinfo("About", "Notepad v15 by Paul Sutton", "http://www.zleap.net")		
...
b.pack(side=LEFT, padx=2, pady=2)
#save file
b = Button(toolbar, text="save_As", width=6, command=save_command)
b.pack(side=LEFT, padx=2, pady=2)
